...
<html lang="es">
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
        ...
        <title>Habilitar Planilla | SEGEBUCO SAC</title>
        ...
        <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li><a href="javascript:;">RRHH</a></li>
                    <li class="active">agregar planilla</li>
                </ol>
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Habilitar Planilla <small>matenimiento planilla</small></h1>
                <!-- end page-header -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <form class="form-horizontal" id="frm_planilla" method="post" action="procesos/reg_planilla.php">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control" id="input_anio" name="input_anio" value="<?php echo date("Y")?>" maxlength="4" required="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="input_semana">Semana</label>
                                        <div class="col-md-2">
                                            <input type="text" class="form-control" id="input_semana" name="input_semana" maxlength="2" value="<?php echo date("W")?>" required="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="input_fin">Fecha Fin</label>
                                        <div class="col-md-3">
                                            <input type="text" class="form-control" id="input_fin" name="input_fin" required="true" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="cbx_local">Trabajo Local?</label>
                                        <div class="col-md-3">
                                            <input type="checkbox" name="cbx_local" id="cbx_local" class="form-control" value="1"/>  
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="input_alimentacion">Alimentacion Diaria</label>
                                        <div class="col-md-2">
                                            <input type="text" name="input_alimentacion" id="input_alimentacion" class="form-control" /> 
                                        </div> 
                                    </div>
                                </div>
