...
if (filter_input(INPUT_GET, 'codigo') != '') {
    $cl_empleado->setCodigo(filter_input(INPUT_GET, 'codigo'));
} else {
    ...
    <body>
        ...
        <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <div class="row">
                    <form class="form-horizontal" enctype="multipart/form-data" id="form_empleado" action="procesos/mod_empleado.php" method="post">
                        <div class="col-md-3">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="image_preview" >
                                                <img id="previewing" src="upload/colaboradores/<?php echo $cl_empleado->getImagen()?>" style="width: 100%"/>
                                            </div>
                                        </div>
                                    </div>
                                    <hr id="line">
                                    <div id="selectImage">
                                        ...
                                        <input type="hidden" name="input_imagen" value="<?php echo $cl_empleado->getImagen()?>" />
                                    </div>
                                    <div id="message"></div>
                            ...
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Codigo" name="input_codigo" id="input_codigo" class="form-control" value="<?php echo $cl_empleado->getCodigo() ?>" readonly="true">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_dni">DNI</label>
                                        <div class="col-sm-3">
                                            <input type="text" placeholder="Nro DNI" name="input_dni" id="input_dni" maxlength="8" value="<?php echo $cl_empleado->getDni() ?>" class="form-control" required>
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" placeholder="Nombres" name="input_nombres" id="input_nombres" class="form-control" value="<?php echo $cl_empleado->getNombres() ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_paterno">Apellido Paterno</label>
                                        <div class="col-sm-5">
                                            <input type="text" placeholder="Apellido Paterno" name="input_paterno" id="input_paterno" class="form-control" value="<?php echo $cl_empleado->getPaterno() ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_materno">Apellido Materno</label>
                                        <div class="col-sm-5">
                                            <input type="text" placeholder="Apellido Materno" name="input_materno" id="input_materno" class="form-control" value="<?php echo $cl_empleado->getMaterno() ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_direccion">Direccion</label>
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Direccion" name="input_direccion" id="input_direccion" class="form-control" value="<?php echo $cl_empleado->getDireccion() ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_email">Email</label>
                                        <div class="col-sm-8">
                                            <input type="text" placeholder="E-mail" name="input_email" id="input_email" class="form-control" value="<?php echo $cl_empleado->getEmail() ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_nacimiento">Fecha de Nacimiento</label>
                                        <div class="col-sm-3">
                                            <input type="text" id="input_nacimiento" name="input_nacimiento" class="form-control" placeholder="dd/mm/aaaa" value="<?php echo $cl_varios->fecha_mysql_web($cl_empleado->getFecha_nacimiento()) ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="select_grado" name="select_grado" class="form-control selectpicker">
                                                ...
                                                foreach ($a_grado as $value) {
                                                    if ($value['id'] == $cl_empleado->getGrado()) {
                                                        $seleccion = "selected='selected'";
                                                    } else {
                                                        $seleccion = "";
                                                    }
                                                    ?>
                                                    <option value="<?php echo $value['id'] ?>" <?php echo $seleccion ?>><?php echo $value['descripcion'] ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="input_profesion" name="input_profesion" class="form-control" placeholder="Profesion" value="<?php echo $cl_empleado->getProfesion() ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_telefono">Telefono / Celular</label>
                                        <div class="col-sm-4">
                                            <input type="text" id="input_telefono" name="input_telefono" class="form-control" placeholder="Telefono - Celular" value="<?php echo $cl_empleado->getTelefono() ?>" maxlength="9">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="input_celular">Telefono Celular</label>
                                        <div class="col-sm-4">
                                            <input type="text" id="input_celular "name="input_celular" class="form-control" placeholder="Telefono - Celular" value="<?php echo $cl_empleado->getCelular() ?>" maxlength="9">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="select_cargo" name="select_cargo" class="form-control selectpicker">
                                                ...
                                                foreach ($a_cargo as $value) {
                                                    if ($value['id'] == $cl_empleado->getCargo()) {
                                                        $seleccion = "selected='selected'";
                                                    } else {
                                                        $seleccion = "";
                                                    }
                                        ...
                                        <div class="col-sm-8">
                                            <select id="select_categoria" name="select_categoria" class="form-control selectpicker">
                                                ...
                                                foreach ($a_categoria as $value) {
                                                    if ($value['id'] == $cl_empleado->getCategoria()) {
                                                        $seleccion = "selected='selected'";
                                                    } else {
                                                        $seleccion = "";
                                                    }
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" id="input_jornal" name="input_jornal" class="form-control" placeholder="Jornal S/" value="<?php echo $cl_empleado->getJornal() ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="select_civil" name="select_civil" class="form-control selectpicker" >
                                                ...
                                                foreach ($a_estado as $value) {
                                                    if ($value['id'] == $cl_empleado->getEstado_civil()) {
                                                        $seleccion = "selected='selected'";
                                                    } else {
                                                        $seleccion = "";
                                                    }
                                ...
                                <div class="panel-footer text-right" >
                                    <button type="submit" class="btn btn-success">Guadar Modificaciones </button>
                                </div>
                            </div>
                        </div>
                    </form>
