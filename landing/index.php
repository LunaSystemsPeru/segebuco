...
<head>
	...
	<title>SEGEBUCO SAC - Servicios Generales Business Consulting SAC</title>
			...
			<div class="col-lg-3">
				<div class="logo">
					<a class="logo_img" href="index-2.html" title="dreamit">
						<img src="assets/images/logo_web_segebuco.png" alt="" />
					</a>
					<a class="main_sticky" href="index-2.html" title="dreamit">
						<img src="assets/images/logo_web_segebuco.png" alt="astute" />
					</a>
				</div>
			</div>
			<div class="col-lg-9">
				<nav class="dreamit_menu">
					<ul class="nav_scroll">
                        ...
                        <li><a href="../consultasCPE/index.php">Consultas CPE</a></li>
...
<!--==================================================-->
<div class="slider_list owl-carousel" id="home">
...
<!--==================================================-->
<div class="about-area pt-70 pb-95" id="about">
	<div class="container">
		<div class="row">		
			<div class="col-lg-6">
				<div class="row">
...
<!--==================================================-->
<div class="service-area pt-50" id="service">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-sm-12">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 left-why-choose-us">
				...
				<div class="stat-levels">
				  ...
				  <div class="stat-1 stat-bar">
				  	 <div class="stat-bar-rating" style="width: 96%;"><span class="percent"></span></div>
				  </div>
				  <h6>Plumbing Experience</h6>
				  <div class="stat-1 stat-bar">
				  	 <div class="stat-bar-rating" style="width: 91%;"><span class="percent"></span></div>
				  </div>
				  <h6>Industrie Experience</h6>
				  <div class="stat-1 stat-bar">
				  	 <div class="stat-bar-rating" style="width: 85%;"><span class="percent"></span></div>
				  </div>
				</div>
			</div>
		</div>
...
<!--==================================================-->
<div class="case-study-title-area" id="project">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-sm-12">
...
<!--==================================================-->
<div class="counter-area style-two pt-90 pb-100">
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-6 col-sm-12">
			...
			<div class="col-lg-3 col-md-6 col-sm-12">
				<div class="dreamit-single-counter-box">
					<div class="single-counter-box-inner">
						<div class="counter-icon">
							<i class="flaticon-electric-generator-2"></i>
						</div>
						<div class="counter-text">
...
<!--==================================================-->
<div class="contact-form-area pb-90" id="contact">
	<div class="container">
