...
$Prestamo->setUsuarioid($_SESSION['usuarioid']);
$a_prestamos = $Prestamo->verPrestamosActivos();
    ...
    <div class="section mt-2 mb-2">
        ...
        <div class="goals">
            ...
            foreach ($a_prestamos as $fila) {
                ...
                $labelFechaPago = '<span class="badge badge-primary">' . $fechapago . '</span>';
                ...
                if ($fechapago == '2000-01-01') {
                    $labelFechaPago = '<span class="badge badge-dark">NO PAGO</span>';
                } else {
                    if ($fechamayora30dias) {
                        $labelFechaPago = '<span class="badge badge-success">' . $fechapago . '</span>';
                    } else if ($fechaentre30y60dias) {
                        $labelFechaPago = '<span class="badge badge-warning">' . $fechapago . '</span>';
                    } else {
                        $labelFechaPago = '<span class="badge badge-danger">' . $fechapago . '</span>';
                    }
                }

                $porcentaje = 100 - $fila['deudaactual'] / $fila['deudatotal'] * 100;

                ?>
                <!-- item -->
                <div class="item">
                    <a href="app-cliente-detalle.php?id=<?php echo $fila['idcliente'] ?>">
                        <div class="in">
                            <div>
                                <h4><?php echo $fila['datos'] ?></h4>
                                <p>Ultimo Pago: <?php echo $labelFechaPago ?></p>
                            </div>
                            <div class="price"><?php echo number_format($fila['deudatotal'], 0) ?></div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo number_format($porcentaje, 0) ?>%;" aria-valuenow="<?php echo number_format($porcentaje, 0) ?>"
