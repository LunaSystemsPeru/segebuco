...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Ver Materiales | SEGEBUCO SAC</title>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <h4 class="panel-title">Ver Materiales </h4>
                            ...
                            <div class="panel-body">
                                <table id="tabla_empleados" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $a_materiales = $cl_material->ver_materiales();
                                        foreach ($a_materiales as $value) {
                                            ?>
                                            <tr class="odd gradeX">
                                                <td class="text-center"><?php echo $cl_varios->zerofill($value['idmaterial'], 5);?></td>
                                                <td><?php echo $value['descripcion']?></td>
                                                <td class="text-right"><?php echo number_format($value['precio_compra'], 2, '.', ',')?></td>
                                                <td class="text-center">Und.</td>
                                                <td class="text-center"><span class="btn btn-success btn-sm">Activo</span></td>
                                                <td class="text-center">
                                                    <a target="_blank" href="mod_materiales.php?codigo=<?php echo $value['idmaterial']?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                    <a href="del_materiales.php?codigo=<?php echo $value['idmaterial']?>" class="btn btn-warning btn-sm"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
