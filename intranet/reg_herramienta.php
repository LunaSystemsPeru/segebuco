...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Registrar Nueva Herramienta | SEGEBUCO SAC</title>
        ...
        <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="active">modificar herramienta</li>
                </ol>
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                ...
                <div class="row">
                    <form class="form-horizontal" id="frm_material" method="post" action="procesos/reg_herramienta.php" enctype="multipart/form-data">
                        <div class="col-md-3">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <div id="image_preview">
                                        <img id="previewing" src="images/materiales/noimage.jpg" width="280px"/>
                                    </div>
                                    <hr id="line">
                                    <div id="selectImage">
                            ...
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="input_marca" name="input_marca"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="input_modelo">Modelo</label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" id="input_modelo" name="input_modelo"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control text-right" id="input_precio" name="input_precio" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="input_caracteristicas">Caracteristicas</label>
                                        <div class="col-md-10">
                                            <textarea class="form-control" name="input_caracteristicas" id="input_caracteristicas"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-footer text-right" >
                                    <button type="submit" class="btn btn-success" name="btn_agregar">Agregar </button>
                                </div>
                            </div>
                        </div>
                    </form>
