                    ...
                    <div class="col-md-4">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                ...
                                <h4 class="panel-title">Gastos de Planilla</h4>
                            </div>
                            <div class="panel-body">
                                        ...
                                        foreach ($a_gastos as $value) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="text-center">
                                                    <a href="procesos/del_gasto_planilla.php?codigo=<?php echo $value['codigo'] ?>&planilla=<?php echo $cl_planilla->getCodigo() ?>" class="btn btn-danger btn-sm"><i class="fa fa-close"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
                        ...
                        <div class="panel panel-inverse">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tabla_planilla" class="table table-striped table-bordered" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Id.</th>
                                        ...
                                        <tbody>
                                            ...
                                            $a_colaborador = $cl_detalle->v_colaboradores_pago();
                                            $contador = 1;
                                            $suma_sueldos = 0;
...
//                                            } else {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="text-center"><?php echo $suma_ingresos; ?></td>
                                                    <td class="text-center"><?php echo $suma_descuento; ?></td>
                                                    <td class="text-right"><?php echo number_format($sueldo_semana, 2, '.', ',') ?></td>
                                                    <td class="text-center">
                                                        <a href="#modal_horas" data-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                                        <a href="#modal_detalle" data-toggle="modal" onclick="cargar_datos_planilla(<?php echo $cl_planilla->getCodigo() ?>, <?php echo $value['colaborador']; ?>)" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                        ...
                                        <tfoot>
                                            <tr class="odd gradeX">
                                                <td class="text-right" colspan="9">Gastos</td>
