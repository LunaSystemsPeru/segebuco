                    ...
                    <div class="page-title-box">
                        <div class="row">
                            ...
                            <div class="col-3 text-right">
                                <a href="form-cotizacion.php" class="btn btn-info"><i class="fa fa-plus"></i> Generar Cotizacion</a>
                            </div>
                        </div><!--end row-->
                ...
                <div class="col-lg-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <br>
                            <p><span class="font-weight-bold">ENCARGADO:</span> MAESTRO1</p>
                            <p><span class="font-weight-bold">MOTORISTA:</span> MAESTRO1</p>
                            <br>
                            <p><span class="font-weight-bold">DETALLE DEL SERVICIO:</span></p>
                            <p>SERVIIO DETALLADO</p>
                        </div><!--end card-body-->
                    </div><!--end card-->
                </div> <!-- end col -->
