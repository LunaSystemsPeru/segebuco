                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <input type="text" id="datos" class="form-control" onchange="mostrar_lista()" placeholder="Busqueda por Maestro o Embarcación ..." oninput="mostrar_lista()">
                                </div>
                                <div class="col-auto align-self-center">
                                    <button class="btn btn-sm btn-outline-success" data-toggle="modal" data-target="#filtro-busqueda">
                                        <i data-feather="search" class="align-self-center icon-xs"></i>Filro por fecha
                                    </button>
                                </div><!--end col-->
                            </div><!--end row-->
    ...
    <script>
        function mostrar_lista() {
            ...
            $.ajax({
                data: datos,
                type: "POST",
                url: "../json/ver-lista-servicio.php",
                success: function(date) {
                    $("#list-servicios").html(date);
                }
            });
        }
    </script>
