                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="form-compra.php" class="btn btn-sm btn-outline-primary">
                                <i data-feather="plus" class="align-self-center icon-xs"></i> Agregar Comprobante de Compra
                            </a>
                            <!--
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">IGV S/</th>
                                        <th class="text-center">Exonerado S/</th>
                                        <th class="text-center">Total S/</th>
                                        <th class="text-center">TipoCompra</th>
                                        <th class="text-center"></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo "FT | E001-21" ?></td>
                                            <td><?php echo "FERRETERIA COMERCIAL SHAROM S.A.C." ?></td>
                                            <td><?php echo "SOL" ?></td>
                                            <td class="text-right"><?php echo "1.000" ?></td>
                                            <td class="text-right"><?php echo "120.00" ?></td>
                                            <td class="text-right"><?php echo "12.00" ?></td>
                                            <td class="text-right"><?php echo "30.00" ?></td>
                                            <td class="text-right"><?php echo "162.00" ?></td>
                                            <td><span class="badge badge-warning">Insumos</span></td>
