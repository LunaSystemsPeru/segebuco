...
<body data-layout="horizontal" class="">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-auto align-self-center">
                                    <button class="btn btn-sm btn-outline-success" data-toggle="modal" data-target="#buscar-guia-remision">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <a href="form-guia-remision.php" class="btn btn-sm btn-outline-primary">
                                    <i data-feather="plus" class="align-self-center icon-xs"></i> Agregar Guia de Remision
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <?php foreach ($Guia->verFilas() as $clave => $fila) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="#" class="btn btn-info btn-sm"><i class="fa fa-file-pdf"></i></a>
                                            ...
                                            <tr>
                                                    ...
                                                    <td class="text-center"><?php echo "10-10-1001" ?></td>
                                                    <td class="text-center"><?php echo "984-2022" ?></td>
                                                    <td><?php echo "HAYDUK S.A." ?></td>
                                                    <td><?php echo "E/P: MARITER | POR CAMBIO DE SISTEMA RSW " ?></td>
                                                    <td><span class="badge badge-warning">Pendiente</span></td>
        ...
        <div class="modal fade" id="buscar-guia-remision" tabindex="-1" role="dialog" aria-labelledby="exampleModalDefaultSignup" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title m-0" id="exampleModalDefaultLogin">Buscar Guia de Remision entre Fechas</h6>
