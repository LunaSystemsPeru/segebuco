                                ...
                                <div class="card-body p-0 auth-header-box">
                                    <div class="text-center p-3">
                                        <a href="#" class="logo logo-admin">
                                            <img src="../../public/imgs/logo_segebuco.png" height="50" alt="logo" class="auth-logo">
                                        </a>
                                        <h4 class="mt-3 mb-1 font-weight-semibold text-white font-18">SEGEBUCO.Gestiona</h4>
                                        <p class="text-black-50 mb-0">Acceder</p>
                                    </div>
                                </div>
                                <div class="card-body p-0">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">                                        
                                            <form class="form-horizontal auth-form" method="post" action="../contents/main.php">
                                                ...
                                                <div class="form-group mb-0 row">
                                                    <div class="col-12">
                                                        <button class="btn btn-warning btn-block waves-effect waves-light" type="submit">Acceder <i class="fas fa-sign-in-alt ml-1"></i></button>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->                           
                                            </form><!--end form-->
                                        </div>
