            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 class="page-title">Hojas de Entrada</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Servicios</a></li>
                                    <li class="breadcrumb-item active">Hojas de Entrada</li>
                                </ol>
                            </div><!--end col-->
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo "10457821" ?></td>
                                            <td class="text-center"><?php echo "450015246589" ?></td>
                                            <td><?php echo "PESQUERA HAYDUK S.A." ?></td>
                                            <td><?php echo "E/P: MARITER | POR CAMBIO DE SISTEMA RSW " ?></td>
                                            <td class="text-right"><?php echo "S/ 16,200.00" ?></td>
                                            <td><?php echo "PEN" ?></td>
