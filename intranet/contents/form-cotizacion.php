            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label" for="apellidosynombres">GLOSA</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label" for="apellidosynombres">Fecha</label>
                                            <input type="date" class="form-control" id="apellidosynombres"
                                                   placeholder="Apellidos y Nombres">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label" for="apellidosynombres">Lugar</label>
                                            <input type="text" class="form-control" id="apellidosynombres"
                                                   placeholder="Apellidos y Nombres">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="apellidosynombres" value="1"
                                                   placeholder="Apellidos y Nombres">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" value="1" class="form-control text-right" id="input-precio-total"
                                               placeholder="1" >
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <p class="card-title">Lista de Insumos</p>
                        </div>
                        <div class="card-body">
