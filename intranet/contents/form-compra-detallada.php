        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col">
                                <h4 class="page-title">Registrar Compra de Insumos</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">Costos y Gastos</a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control text-right" id="input-precio-sinigv"
                                                   placeholder="0.00" value="0.00000" onkeyup="obtenerTotal()">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label" for="input-precio-total">Costo Unit c/IGV</label>
                                            <input type="number" value="0.00" class="form-control text-right" id="input-precio-total"
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Lista de Insumos del Comprobante</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" value="1" id="hidden-idcontrato">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="input_datos_cliente">Buscar Proveedor</label>
                                            <input type="text" class="form-control" id="input_datos_cliente"
                                                   placeholder="Escriba razon social o ruc" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label class="form-label" for="input_documento_cliente">Nro Documento Proveedor</label>
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="input_documento_cliente"
                                                       placeholder="ingrese DNI o RUC" maxlength="11" value="">
                                                <input type="hidden" id="hidden-idcliente" value="1">
                                    ...
                                    <div class="col-md-12 align-content-center">
                                        <div class="media mb-auto">
                                            <div class="media-body ">
                                                <p class="col-form-label mb-0">Total a pagar </p>
