...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Agregar Material - Insumo | SEGEBUCO SAC</title>
        ...
        <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="active">agregar material</li>
                </ol>
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Registrar Material <small>mantenimiento almacenes</small></h1>
                <!-- end page-header -->

                <div class="row">
                    <form class="form-horizontal" id="frm_material" method="post" action="procesos/reg_material.php" enctype="multipart/form-data">
                        <div class="col-md-3">
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    <div id="image_preview">
                                        <img id="previewing" src="images/materiales/noimage.jpg" style="width: 100%"/>
                                    </div>
                                    <hr id="line">
                                    <div id="selectImage">
                            ...
                            <div class="panel panel-inverse">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" class="form-control text-center" id="input_id" name="input_id" readonly="true"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="input_clasificacion">Clasificacion</label>
                                        <div class="col-md-10">
                                            <select class="form-control" name="input_clasificacion">
                                                <?php
                                                $cl_detalle->setTabla(9);
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="input_unidad">Unidad Med.</label>
                                        <div class="col-md-10">
                                            <select class="form-control" name="input_unidad">
                                                <?php
                                                $cl_detalle->setTabla(6);
                                                $a_detale = $cl_detalle->v_detalle();
                                                foreach ($a_detale as $value) {
                                                    ?>
                                                    <option value="<?php echo $value['id'] ?>"><?php echo $value['descripcion'] ?></option>
                                                    <?php
                                                }
