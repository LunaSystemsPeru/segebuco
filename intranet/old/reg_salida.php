...
$_SESSION['retorno_botellas'] = array();
...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Agregar Documento de Devolucion de Cilindros | SEGEBUCO SAC</title>
        ...
        <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="active">agregar documento devolucion</li>
                </ol>
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Registro de Documento de Devolucion <small>matenimiento almacenes</small></h1>
                <!-- end page-header -->
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="input_almacen" value="1" />
                                                        <div class="col-md-10">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="col-md-2 control-label">Costo Sin IGV</label>
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control text-right"  name="input_costo_material" id="input_costo_material"/>
                                                        </div>
                                                        <div class="col-md-1">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <a class="btn btn-success" href="" tarjet="_blank">Nueva Hetramienta</a>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="col-md-2 control-label">Costo Sin IGV</label>
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control text-right"  name="input_costo_herramienta" id="input_costo_herramienta" readonly="true"/>
                                                        </div>
                                                        <div class="col-md-2">
                ...
                $("#input_buscar_herramientas").autocomplete({
                    ...
                    select: function (event, ui) {
                        ...
                        if (tipo === '1') {
                            ...
                            $('#input_tipo_herramienta').val("MANUAL");
