...
<html lang="es">
    ...
    <head><meta http-equiv="Content-Type" content="text/html; charset=euc-jp">
        ...
        <title>Ver Perfil Usuario | SEGEBUCO SAC</title>
    ...
    <body>
        ...
        <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Ver Perfil <small>matenimiento usuario</small></h1>
                <!-- end page-header -->
                                    ...
                                    <table class="table table-profile">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><i class="fa fa-mobile fa-lg m-r-5"></i> <?php echo $cl_empleado->getTelefono()?> <a href="mod_empleado.php?codigo=<?php echo $_SESSION['empleado']?>" class="m-l-5">Editar</a></td>
                                            </tr>
                                            <tr class="divider">
                                                <td colspan="2"></td>
                                            </tr>
                                            <tr class="highlight">
                                                ...
                                                <td><?php echo $cl_almacen->getNombre()?>  <a href="mod_perfil.php?usuario=<?php echo $_SESSION['usuario']?>" class="m-l-5">Cambiar</a></td>
                                            </tr>
                                            <tr class="highlight">
                                                <td class="field">Contraseña</td>
                                                <td>**********  <a href="mod_perfil.php?usuario=<?php echo $_SESSION['usuario']?>" class="m-l-5">Cambiar</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
