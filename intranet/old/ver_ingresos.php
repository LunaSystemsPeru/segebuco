...
if (filter_input(INPUT_GET, 'periodo') != '') {
    $cl_ingresos->setPeriodo(filter_input(INPUT_GET, 'periodo'));
} else {
    $cl_ingresos->setPeriodo(date('Y') . date('m'));
}
?>
<!DOCTYPE html>
...
<html lang="es">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Ver Ingresos | SEGEBUCO SAC</title>
    ...
    <body>
        ...
        <div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
            ...
            <div id="content" class="content">
                ...
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header">Ingresos <small>matenimiento almacenes</small></h1>
                <!-- end page-header -->
                        ...
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <div class="panel-heading-btn">
                                    <select class="form-control" id="select_periodo" name="select_periodo">
                                        ...
                                        <?php
                                        $a_periodos = $cl_ingresos->ver_periodo();
                            ...
                            <div class="panel-body">
                                <table id="tabla_ingresos" class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $a_ingresos = $cl_ingresos->ver_ingresos();
                                        foreach ($a_ingresos as $value) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="text-center">
                                                	<a href="reportes/pdf_ver_documento_ingreso.php?codigo=<?php echo $value['periodo'] . $value['id'] ?>" target="_blank" class="btn btn-warning btn-sm"><i class="fa fa-print"></i> Ver</a>
                                                	<button onclick="confirmar('procesos/del_ingreso.php?codigo=<?php echo $value['periodo'] . $value['id'] ?>')" class="btn btn-danger btn-sm" title="Eliminar Doc. Ingreso"><i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>  
                                            <?php
                                        }
