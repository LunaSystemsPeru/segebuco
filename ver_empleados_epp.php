                    ...
                    <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <a href="reg_entrega_epp.php" class="btn btn-success btn-sm" >Registrar Entrega</a>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive123">
                                    <table id="tabla_empleados" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php
                                            $a_empleados = $cl_empleado->v_tabla_empleados_epp();
                                            foreach ($a_empleados as $value) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="ver_entrega_epp.php?codigo=<?php echo $value['id'] ?>" alt="Entregar EPPs" class="btn btn-warning btn-sm"><i class="fa fa-shield"></i> EPP</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
