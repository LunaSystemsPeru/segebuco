                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" class="form-control text-right" placeholder="0.00"
                                                   name="input_subtotal" id="input_subtotal" readonly="true"/>
                                        </div>
                                        <label class="col-md-1 control-label">IGV</label>
                                        <div class="col-md-2">
                                            <input type="text" class="form-control text-right" placeholder="0.00"
                                                   name="input_igv" id="input_igv" readonly="true"/>
                                        </div>
                                        <label class="col-md-1 control-label">Total</label>
                                        <div class="col-md-2">
                                            <input type="text" class="form-control text-right" placeholder="0.00"
                                                   onkeyup="calcular_total()" name="input_total" id="input_total" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
